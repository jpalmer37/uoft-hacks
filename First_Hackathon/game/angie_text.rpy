label angie_text:
    ...
    a "Wanna take a look at one of mine? Here’s one I did last weekend! Nothing too fancy. This is a gradient boosted machine learning model to predict whether a tumor is cancerous or not!"
    you "{i}I didn’t understand a single word in that last sentence …{\i}"
    show Angie Happy
    a "...here’s my cross-validation … couldn’t decide between classifiers …"
    ...
    you "{i}Wait, what?? That’s awesome?{\i}"
    show Angie Happy
    a "Don’t be ashamed of it! No need to hide it. Everyone has to start somewhere! Good on you for taking the first steps! Those can be the hardest!"
    you "What? You’re not upset? I thought you’d be frustrated that you’re on a team with a beginner! You’re so experienced!"
    show Angie Happy
    a "Not at all! Happy to share my knowledge! Want me to introduce you to some packages we might be using?"
    you "Are you sure? I feel like a burden…"
    show Angie Motivated
    a "Hey none of that!! You’re doing FINE! Others helped me when I was starting, so why can’t I help you?"
    jump end
